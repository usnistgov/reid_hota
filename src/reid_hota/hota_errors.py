...
class InvalidIDAlignmentMethodError(HOTAConfigError):
    ...
    def __reduce__(self):
        return (InvalidIDAlignmentMethodError, (self.method, self.valid_methods))
...
class InvalidSimilarityMetricError(HOTAConfigError):
    ...
    def __reduce__(self):
        return (InvalidSimilarityMetricError, (self.metric, self.valid_metrics))
...
class UnsupportedBoxFormatError(HOTAConfigError):
    ...
    def __reduce__(self):
        return (UnsupportedBoxFormatError, (self.box_format,))
...
class InvalidIOUThresholdsRangeError(HOTAConfigError):
    ...
    def __reduce__(self):
        return (InvalidIOUThresholdsRangeError, (self.thresholds,))
...
class NonFiniteSimilarityValueError(HOTARuntimeError):
    ...
    def __reduce__(self):
        return (NonFiniteSimilarityValueError, (self.video_id, self.frame, self.i_ids, self.j_ids, self.cost_matrix))
...
class MissingVideoIDError(HOTARuntimeError):
    ...
    def __reduce__(self):
        return (MissingVideoIDError, (self.context,))
...
class DuplicateIDError(HOTARuntimeError):
    ...
    def __reduce__(self):
        return (DuplicateIDError, (self.is_ground_truth, self.video_id, self.frame, self.duplicate_ids))
